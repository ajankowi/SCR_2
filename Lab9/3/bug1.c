...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  pthread_create(&threads[1], &attr, inc_count, (void *)2);
  pthread_create(&threads[2], &attr, inc_count, (void *)3);
  pthread_create(&threads[3], &attr, inc_count, (void *)4);
  pthread_create(&threads[4], &attr, inc_count, (void *)5);
  pthread_create(&threads[5], &attr, inc_count, (void *)6);
